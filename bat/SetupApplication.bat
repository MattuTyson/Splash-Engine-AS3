...
:: Android packaging
set AND_CERT_NAME="Space Jump"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SpaceJump.p12
...
set IOS_PROVISION=cert\SpaceJump.mobileprovision
...
set APP_ID=air.SpaceJump

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SpaceJump
